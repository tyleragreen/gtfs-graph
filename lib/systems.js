var Systems = {
  ...
  MBTA: {
    ...
    stops_view: "SELECT * FROM stops WHERE location_type='t'",
    routes_view: "SELECT DISTINCT st.stop_id AS stop_id, r.route_id AS route_id FROM stop_times st JOIN trips t ON st.trip_id=t.trip_id JOIN routes r ON t.route_id=r.route_id WHERE r.route_desc LIKE 'Rapid Transit'",
    edges_view: "SELECT * FROM stop_times"
  }
};

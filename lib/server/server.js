...
exports.listen = function(SystemManager) {
  ...
  io.on('connection', function (socket) {
    ...
    socket.on(socketMsg.requestStops, function(system) {
      ...
      socket.emit(socketMsg.sendMergedStops, SystemManager.getGraph(system).mergedGraph.stops);
    });
    ...
    socket.on(socketMsg.requestMergedEdges, function(system) {
      socket.emit(socketMsg.sendMergedEdges, SystemManager.getGraph(system).mergedGraph.edgesAsGeoJsonFeatures());
    });

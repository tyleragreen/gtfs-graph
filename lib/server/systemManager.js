...
class SystemManager {
  ...
  analyzeGraphs() {
    this.systems.forEach(function(system,index) {
      ...
      system.graph.getGraphToUse().calculateRandomWalks(50, 66);
      logger.info("Analyzing " + system.id + " random walking");
      system.graph.outwardAccessibilities = traversals.outwardAccessibility(system.graph.getGraphToUse());
      logger.info("Analyzing " + system.id + " DONE");
    });
  }
}

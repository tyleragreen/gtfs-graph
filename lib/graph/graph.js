...
class TransitGraph {
  ...
  transitionProbability(j, origin, distance) {
    ...
    //  console.log('origin',origin,'Dest',j,'distance',distance,'prob',numerator.length / randomWalks.length, 'num',numerator.length,'denom',randomWalks.length);
    //}
  ...
  calculateRandomWalksFrom(node, count, distance) {
